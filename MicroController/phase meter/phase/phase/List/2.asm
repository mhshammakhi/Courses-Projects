...
_0x0:
	.DB  0x50,0x68,0x61,0x73,0x65,0x3D,0x20,0x25
	.DB  0x64,0x0
_0x2040003:
	.DB  0x80,0xC0
_0x2060060:
...
; 0000 0097 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0098 ADCSRA=0xA3;
	LDI  R30,LOW(163)
	OUT  0x6,R30
; 0000 0099 SFIOR&=0x1F;
	IN   R30,0x30
	ANDI R30,LOW(0x1F)
	OUT  0x30,R30
; 0000 009A 
...
; 0000 00A4       {
; 0000 00A5 
; 0000 00A6       if (read_adc(0)==0x7f) {a=0x7f-read_adc(1);b=a/256;c=isqrt(b);d=2*asin(c);e=180*d/PI;f=e;lcd_init(16);lcd_clear();sprintf(str,"Phase= %d",a);lcd_puts(str);}
	LDI  R26,LOW(0)
	RCALL _read_adc
	CPI  R30,LOW(0x7F)
	BREQ PC+3
